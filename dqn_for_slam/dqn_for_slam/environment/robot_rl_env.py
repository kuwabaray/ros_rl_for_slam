...
class RobotEnv(gym.Env):
    ...
    def reset(self):
        ...
        time.sleep(SLEEP_AFTER_RESET_TIME)
    ...
    def _update_map_completeness(self):
        ...
        self.map_completeness_pct = ((num_occupied+num_unoccupied)/sum)/MAP_SIZE_RATIO


    def _send_action(self, steering, throttle):
        speed = Twist()
